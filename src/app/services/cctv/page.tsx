...
const FEATURES = [
  {
    icon: Cctv,
    title: "2 MP – 8 MP cameras",
    body: "Bullet, dome and PTZ cameras in HD, 2K and 4K to match every budget and coverage need.",
  },
  {
    icon: Moon,
    title: "Colour night vision",
    body: "ColorVu and IR cameras keep your property clearly visible around the clock.",
  },
  {
    icon: Smartphone,
    title: "Mobile viewing",
    body: "Live feeds and playback on iOS & Android  watch your property from anywhere.",
  },
  {
    icon: HardDrive,
    title: "DVR / NVR storage",
    body: "Local recording with the storage you need, plus optional cloud backup.",
  },
  {
    icon: Wifi,
    title: "Remote setup",
    body: "We configure remote viewing, alerts and user accounts before we leave site.",
  },
  {
    icon: ShieldCheck,
    title: "Weather-sealed",
    body: "IP66/IP67 outdoor housings and tidy, protected conduit runs that last.",
  },
];
...
const STEPS = [
  {
    n: "01",
    t: "Site walk",
    b: "We map entry points, blind spots and cable routes for full coverage.",
  },
  {
    n: "02",
    t: "Design & quote",
    b: "Camera count, resolution, storage and a clear fixed price.",
  },
  {
    n: "03",
    t: "Neat install",
    b: "Weather-sealed cameras, tidy conduit and a tested recorder.",
  },
  {
    n: "04",
    t: "Handover",
    b: "Mobile app, remote viewing and playback set up and demonstrated.",
  },
];
    ...
    <main>
      <PageHero
        ...
        title={
          <>
            Eyes on everything,{" "}
            <span className="text-gradient">day and night</span>.
          </>
        }
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="lead mt-5 max-w-lg">
                From a 4-camera home kit to a multi-camera business grid we plan
                overlapping fields of view, install cleanly and hand over a
              ...
              <ul className="mt-6 grid gap-2.5 sm:grid-cols-2">
                {[
                  ...
                  <li
                    key={f}
                    className="flex items-center gap-2 text-sm text-fg/75"
                  >
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <Link href="/products/cameras" className="btn-outline">
                  Browse cameras
                </Link>
              </div>
            </div>
