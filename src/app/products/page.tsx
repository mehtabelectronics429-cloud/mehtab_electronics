...
import { SOLAR_PANELS, INVERTERS, BATTERIES, CAMERA, HERO_INVERTER } from "@/lib/assets";
  ...
  return (
    <main>
      <PageHero
        ...
        title={<>Genuine hardware, <span className="text-gradient">ready to install</span>.</>}
        ...
        image={HERO_INVERTER}
        chips={["Genuine & warrantied", "Dealer pricing", "Instant WhatsApp quote"]}
      />
