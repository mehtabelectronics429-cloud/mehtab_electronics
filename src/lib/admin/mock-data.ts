...
export const EMPLOYEES: Employee[] = [
  ...
  },
  {
    id: "e4",
    name: "Zoya Ali",
    email: "zoya@mehtabelectronics.com",
...
export const ACTIVITY: ActivityItem[] = [
  ...
  },
  {
    ...
    target: "PKR 560,000",
    at: "2026-07-05T15:02:00",
    kind: "payment",
  },
  {
    id: "a5",
    actor: "Fatima Noor",
    action: "completed installation",
    target: "INST-1041",
    at: "2026-07-01T13:44:00",
    kind: "install",
  },
];
...
export const NOTIFICATIONS: AppNotification[] = [
  {
    ...
    body: "INST-1043 submitted by Ahmed Sheikh",
    at: "2026-07-06T09:12:00",
    read: false,
    kind: "approval",
  },
  {
    id: "n2",
    title: "Low stock",
    body: "NVR5216 has only 3 units left",
    at: "2026-07-06T08:40:00",
    read: false,
    kind: "stock",
  },
  {
    ...
    body: "PKR 560,000 from Sana Malik",
    at: "2026-07-05T15:02:00",
    read: true,
    kind: "payment",
  },
...
export const MONTHLY_INSTALLS = [
  12, 18, 15, 22, 19, 26, 24, 30, 28, 34, 31, 38,
];
export const MONTHLY_REVENUE = [
  6.2, 8.1, 7.4, 9.8, 8.9, 11.2, 10.4, 13.1, 12.2, 15.4, 14.1, 18.4,
];
export const MONTHLY_EXPENSES = [
  3.1, 4.0, 3.6, 4.9, 4.4, 5.6, 5.1, 6.4, 6.0, 7.6, 6.9, 9.1,
];
export const MONTHS = [
  "Jan",
  "Feb",
