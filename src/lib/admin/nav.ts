...
export const NAV: NavItem[] = [
  ...
  { label: "Complaints", href: "/admin/complaints", icon: "MessageSquareWarning", cap: "complaints.view", group: "Operations" },
  ...
  { label: "Expenses", href: "/admin/expenses", icon: "Wallet", cap: "expenses.view", group: "Finance" },
  { label: "Employees", href: "/admin/employees", icon: "IdCard", cap: "employees.view", group: "Team" },
  { label: "Employee Payments", href: "/admin/employee-payments", icon: "HandCoins", cap: "payroll.view", group: "Team" },
  ...
  { label: "Installation Videos", href: "/admin/installation-videos", icon: "Video", cap: "content.manage", group: "System" },
