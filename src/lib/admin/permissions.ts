...
const MATRIX: Record<Role, Capability[]> = {
  admin: [
    ...
    "reports.view", "settings.manage",
    "pos.use", "suppliers.view", "suppliers.manage", "purchases.view", "purchases.manage",
    "profile.view",
  ],
  ...
  manager: [
    ...
    "inventory.view", "billing.view.all", "billing.manage", "billing.approve",
    "ledger.view.all", "ledger.manage", "ledger.approve",
    "employees.view", "whatsapp.view", "whatsapp.send", "reports.view",
    "pos.use", "suppliers.view", "suppliers.manage", "purchases.view", "purchases.manage",
    "profile.view",
  ],
  ...
  cashier: [
    ...
    "products.view", "inventory.view", "materials.view",
    "suppliers.view", "suppliers.manage", "purchases.view", "purchases.manage",
    "billing.view.all", "billing.manage",
    "ledger.view.all",
    "whatsapp.send",
    "profile.view",
  ],
