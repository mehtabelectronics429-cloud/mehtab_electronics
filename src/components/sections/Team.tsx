  ...
  return (
    ...
    >
      <SectionHeading
        ...
        title={
          <>
            Engineers who <span className="text-gradient">obsess</span> over the
            details.
          </>
        }
          ...
          <Reveal key={m.name} delay={(i % 4) * 0.08}>
            <TiltCard className="group relative overflow-hidden rounded-3xl glass hairline">
              <div className="relative aspect-[4/5]">
                ...
                <span className="absolute left-4 top-4 rounded-full glass hairline px-3 py-1 text-[0.65rem] uppercase tracking-widest text-gray-800 ">
                  {m.role}
                </span>
                <div
                ...
                >
                  ...
                  <p className="mt-1 text-xs text-gray-200">{m.role}</p>
                </div>
              </div>
              <div className="p-5  h-32">
                <p className="text-sm dark:text-white/80 text-gray-800">
                  {m.description}
                </p>
              </div>
            </TiltCard>
