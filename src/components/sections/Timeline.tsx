  ...
  return (
    <section className="relative mx-auto max-w-5xl px-6 py-28 md:py-40">
      <SectionHeading
        ...
        title={
          <>
            Thirty years, <span className="text-gradient">one obsession</span>.
          </>
        }
      />
          ...
          {TIMELINE.map((t, i) => (
            <Reveal key={t.year} delay={i * 0.05}>
              ...
              >
                ...
                <div
                  className={`md:w-1/2 ${i % 2 === 0 ? "md:pl-10" : "md:pr-10 md:text-right"}`}
                >
                  <div className="rounded-3xl glass hairline p-6 transition-transform duration-500 hover:-translate-y-1">
                    ...
                    <h3 className="mt-2 font-display text-base text-fg">
                      {t.title}
                    </h3>
