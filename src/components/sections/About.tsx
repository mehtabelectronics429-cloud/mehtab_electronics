...
const pillars = [
  {
    ...
    body: "Every install is designed, load-calculated and commissioned by certified engineers  not guesswork.",
  },
  {
    icon: Leaf,
    title: "Clean by default",
    body: "We treat energy independence and lower bills as the baseline, not a premium upsell.",
  },
  {
    icon: Target,
    title: "One accountable partner",
    body: "Solar panels, inverters and security cameras under a single roof, warranty and support line.",
  },
];
      ...
      <div className="grid items-center gap-14 lg:grid-cols-2">
        <div>
          <SectionHeading
            ...
            title={
              <>
                The energy & security studio for the{" "}
        ...
        <Reveal delay={0.15} className="relative">
          <GlassCard className="overflow-hidden p-2">
            <SmartImage
              src={img("photo-1600607687939-ce8a6c25118c", 1200)}
              alt="Modern smart home interior at dusk"
          ...
          <div className="absolute -bottom-6 -left-6 hidden w-56 rounded-2xl glass hairline p-5 md:block">
            ...
            <div className="mt-1 text-xs text-fg/50">
              of solar deployed across Punjab & beyond
            </div>
          </div>
